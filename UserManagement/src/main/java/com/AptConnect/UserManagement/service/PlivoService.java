...
public class PlivoService {
    ...
    private String srcPhoneNumber="8463961778";
    public PlivoService() {
    ...
    public void sendSMS(String destPhoneNumber, String messageContent) {
        try {
            MessageCreateResponse response = (MessageCreateResponse)Message.creator(this.srcPhoneNumber,
                    Collections.singletonList(destPhoneNumber), messageContent).create();
            System.out.println("SMS sent successfully to " + destPhoneNumber + ". Message UUID: " +
                    String.valueOf(response.getMessageUuid()));
